...
async function main() {
    ...
    const url = new URL(
        params.get("url") || "/data/3dgs_output/scene.splat",
        window.location.href
    );
    const msg = document.getElementById("message");
    const prog = document.getElementById("progress");
    msg.innerText = "Fetching splat file...";
    ...
    msg.innerText = "Setting up WebGL...";
